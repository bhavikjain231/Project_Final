({
    ...
    getSelectedRecords: function(component, event, helper) {
        ...
        var action = component.get("c.saveChildRecord");
        action.setParams({
            account : selectedRecords,
            oCd:component.get("v.oppCloseDate"),
            oStage:component.get("v.oppStageName"),
            ousd:component.get("v.oppAmountUsd")
        });
        alert("set Params " +JSON.stringify( action.getParams()));
