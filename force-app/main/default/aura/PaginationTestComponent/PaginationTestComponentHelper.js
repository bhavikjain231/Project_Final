({
    ...
    deleteAllHelper : function(component, event, helper)
    {
        ...
        var instanceOfDelete = component.get("c.isDeleteApex");
        instanceOfDelete.setParams({ 
            row:selectedRecords
        });
        instanceOfDelete.setCallback(this, function(response) {
            var state = response.getState();
            if (state === "SUCCESS") {
        ...
        $A.enqueueAction(instanceOfDelete);	 
        location.reload();
    }
})